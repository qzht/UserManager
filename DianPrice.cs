...
{
    public partial class DianPrice : Form
    {
        public DianPrice()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int flag = db.NonQuery(" update Price set DianPrice='" + price + "'");
            if (flag == 1)
            {
        ...
        private void WaterPrice_Load(object sender, EventArgs e)
        {
            ...
            {
                db.NonQuery(" insert into Price (DianPrice) values('0')");
                return;
            }
            if (dt != null && dt.Rows.Count == 1)
            {
                txtWaterPrice.Text = dt.Rows[0]["DianPrice"].ToString();
            }
        }
    }
}
